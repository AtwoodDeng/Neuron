...
# model name
# model_name = "aeif_cond_nmda_alpha"
model_name = "iaf_cond_exp"
...
nest.CopyModel(model_name, "wifi_neuron", wifi.dict)
...
nest.CopyModel(model_name, "nafi_neuron", nafi.dict)
...
nest.CopyModel(model_name, "qv_neuron", qv.dict)
...
nest.CopyModel(model_name, "qvinhup_neuron", qvinh.dict)
...
nest.CopyModel(model_name, "buildup_neuron", build.dict)
...
nest.CopyModel(model_name, "buildinhup_neuron", buildinh.dict)
...
nest.CopyModel(model_name, "burst_neuron", burst.dict)
...
nest.CopyModel(model_name, "inhib_neuron", inhib.dict)
...
tt.get_topology_seperate('SCmodel')
